...
For each dataset obtained in the phase described in Chapter \ref{preprocessing},
...
As we can see from Figure MIAOMIAO, applying a filter removes topics which are prevalent in all documents.
