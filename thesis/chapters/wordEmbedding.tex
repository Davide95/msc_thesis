...
GloVe was proposed to overcame the limitations of Word2vec.
...
\begin{itemize}
    ...
    \item $f$ needs to have a cutoff to avoid weighting terms that appears too often in the text and that does not convey semantic information.
          These terms are commonly called \say{stop words} in the literature. Examples are \say{the}, \say{a}, \say{from} and so on and so forth.
\end{itemize}
...
In the previous sections the term \say{close} was intentionally vague.
