...
\begin{minipage}{\linewidth}
    \lstinputlisting[caption=requirements.txt]{../code/spider/requirements.txt}
\end{minipage}

\begin{minipage}{\linewidth}
    \lstinputlisting[language=Python, caption=custom\_spider.py]{../code/spider/custom_spider.py}
\end{minipage}