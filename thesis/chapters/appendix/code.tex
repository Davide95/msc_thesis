...
Run \say{\texttt{python data\_preparation.py --help}} for more information.

\inputminted{Python}{../code/data_preparation.py}

\pagebreak
\section{Doctopic} \label{doctopic_code}
The script has some mandatory and optional parameters.
Run \say{\texttt{python doctopic.py --help}} for more information.
...
\section{Distances}
The script has some mandatory and optional parameters.
Run \say{\texttt{python distances.py --help}} for more information.
