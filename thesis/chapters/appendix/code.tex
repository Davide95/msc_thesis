...
\lstinputlisting[language=Python, caption=random\_spider.py]{../code/random_spider.py}
...
\lstinputlisting[language=Python, caption=random\_threshold.py]{../code/random_threshold.py}