...
\begin{figure}[h]
    \centering
    \subfigure{\includegraphics[width=0.5\textwidth]{images/nn-linear.eps}}
...
\begin{figure}[h]
    \centering
    \subfigure{\includegraphics[width=0.5\textwidth]{images/nn-multi.eps}}
...
\begin{figure}[h]
    \centering
    \subfigure{\includegraphics[width=0.5\textwidth]{images/nn-chain.eps}}
...
In order to compute the partial derivatives, we can start from the last layer and then use them to compute
